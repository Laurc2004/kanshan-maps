...
export default function SourceIndex({ sources }: { sources: KnowledgeSource[] }) {
  ...
  return (
    <div className="absolute bottom-3 left-3 z-10 max-w-[calc(100%-9rem)] rounded-[12px] border border-[#e8e8e3] bg-white/95 px-3 py-2 shadow-sm backdrop-blur" data-testid="source-index">
      <div className="mb-1 text-[10px] font-semibold tracking-wide text-gray-500">来源索引 · 知乎 {sources.length} 篇</div>
      <div className="thin-scroll flex max-w-[62vw] gap-2 overflow-x-auto pb-0.5">
